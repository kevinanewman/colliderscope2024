...
class Ui_ColliderScopeUI(object):
    def setupUi(self, ColliderScopeUI):
        ...
        ColliderScopeUI.resize(1035, 918)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(ColliderScopeUI.sizePolicy().hasHeightForWidth())
        ColliderScopeUI.setSizePolicy(sizePolicy)
        ...
        sizePolicy2.setHeightForWidth(self.tabWidget_main.sizePolicy().hasHeightForWidth())
        self.tabWidget_main.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.filepathname_label.sizePolicy().hasHeightForWidth())
        self.filepathname_label.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.file_preview_tableWidget.sizePolicy().hasHeightForWidth())
        self.file_preview_tableWidget.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.file_import_tabWidget.sizePolicy().hasHeightForWidth())
        self.file_import_tabWidget.setSizePolicy(sizePolicy5)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 274, 536))
        ...
        sizePolicy7.setHeightForWidth(self.import_csv_encoding_comboBox.sizePolicy().hasHeightForWidth())
        self.import_csv_encoding_comboBox.setSizePolicy(sizePolicy7)
        ...
        sizePolicy7.setHeightForWidth(self.import_csv_delimiter_comboBox.sizePolicy().hasHeightForWidth())
        self.import_csv_delimiter_comboBox.setSizePolicy(sizePolicy7)
        ...
        sizePolicy5.setHeightForWidth(self.import_csv_parameter_tableWidget.sizePolicy().hasHeightForWidth())
        self.import_csv_parameter_tableWidget.setSizePolicy(sizePolicy5)
        ...
        sizePolicy7.setHeightForWidth(self.import_csv_pushButton.sizePolicy().hasHeightForWidth())
        self.import_csv_pushButton.setSizePolicy(sizePolicy7)
        ...
        sizePolicy5.setHeightForWidth(self.import_excel_parameter_tableWidget.sizePolicy().hasHeightForWidth())
        self.import_excel_parameter_tableWidget.setSizePolicy(sizePolicy5)
        ...
        sizePolicy7.setHeightForWidth(self.import_excel_pushButton.sizePolicy().hasHeightForWidth())
        self.import_excel_pushButton.setSizePolicy(sizePolicy7)
        ...
        sizePolicy8.setHeightForWidth(self.column_groupBox.sizePolicy().hasHeightForWidth())
        self.column_groupBox.setSizePolicy(sizePolicy8)
        ...
        sizePolicy9.setHeightForWidth(self.triage_filter_widget.sizePolicy().hasHeightForWidth())
        self.triage_filter_widget.setSizePolicy(sizePolicy9)
        ...
        sizePolicy10.setHeightForWidth(self.triage_numeric_listWidget.sizePolicy().hasHeightForWidth())
        self.triage_numeric_listWidget.setSizePolicy(sizePolicy10)
...
"")
        ...
        sizePolicy11.setHeightForWidth(self.add_to_script_toolButton.sizePolicy().hasHeightForWidth())
        self.add_to_script_toolButton.setSizePolicy(sizePolicy11)
...
"")
        ...
        sizePolicy1.setHeightForWidth(self.ignore_pushButton.sizePolicy().hasHeightForWidth())
        self.ignore_pushButton.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.unignore_pushButton.sizePolicy().hasHeightForWidth())
        self.unignore_pushButton.setSizePolicy(sizePolicy1)
...
"color: black;")
        ...
        sizePolicy12.setHeightForWidth(self.script_preview_consoleWidget.sizePolicy().hasHeightForWidth())
        self.script_preview_consoleWidget.setSizePolicy(sizePolicy12)
        ...
        sizePolicy.setHeightForWidth(self.export_tab.sizePolicy().hasHeightForWidth())
        self.export_tab.setSizePolicy(sizePolicy)
        ...
        sizePolicy14.setHeightForWidth(self.nanhandler_widget.sizePolicy().hasHeightForWidth())
        self.nanhandler_widget.setSizePolicy(sizePolicy14)
        self.nanhandler_widget.setMinimumSize(QSize(100, 0))
        ...
        sizePolicy9.setHeightForWidth(self.export_signal_buttons_layout.sizePolicy().hasHeightForWidth())
        self.export_signal_buttons_layout.setSizePolicy(sizePolicy9)
        ...
        self.file_export_browse_horizontalLayout = QHBoxLayout()
        self.file_export_browse_horizontalLayout.setObjectName(u"file_export_browse_horizontalLayout")
        ...
        sizePolicy3.setHeightForWidth(self.filepathname_label_2.sizePolicy().hasHeightForWidth())
        self.filepathname_label_2.setSizePolicy(sizePolicy3)

        self.file_export_browse_horizontalLayout.addWidget(self.filepathname_label_2)

        self.export_folder_filepathname_lineEdit = QLineEdit(self.export_options_groupBox)
        self.export_folder_filepathname_lineEdit.setObjectName(u"export_folder_filepathname_lineEdit")
        self.export_folder_filepathname_lineEdit.setEnabled(False)
        self.export_folder_filepathname_lineEdit.setFrame(False)
        self.export_folder_filepathname_lineEdit.setClearButtonEnabled(False)

        self.file_export_browse_horizontalLayout.addWidget(self.export_folder_filepathname_lineEdit)

        self.file_export_folder_browse_pushButton = QPushButton(self.export_options_groupBox)
        self.file_export_folder_browse_pushButton.setObjectName(u"file_export_folder_browse_pushButton")
        self.file_export_folder_browse_pushButton.setAutoDefault(True)

        self.file_export_browse_horizontalLayout.addWidget(self.file_export_folder_browse_pushButton)


        self.verticalLayout_25.addLayout(self.file_export_browse_horizontalLayout)
        ...
        sizePolicy7.setHeightForWidth(self.export_data_prefix_lineEdit.sizePolicy().hasHeightForWidth())
        self.export_data_prefix_lineEdit.setSizePolicy(sizePolicy7)
        ...
        sizePolicy11.setHeightForWidth(self.export_data_prefix_filler_comboBox.sizePolicy().hasHeightForWidth())
        self.export_data_prefix_filler_comboBox.setSizePolicy(sizePolicy11)
        ...
        self.export_data_lineEdit.setEnabled(False)
        ...
        sizePolicy11.setHeightForWidth(self.export_data_suffix_filler_comboBox.sizePolicy().hasHeightForWidth())
        self.export_data_suffix_filler_comboBox.setSizePolicy(sizePolicy11)
        ...
        sizePolicy7.setHeightForWidth(self.export_data_suffix_lineEdit.sizePolicy().hasHeightForWidth())
        self.export_data_suffix_lineEdit.setSizePolicy(sizePolicy7)
        ...
        self.horizontalLayout_21 = QHBoxLayout(self.export_mode_groupBox)
        ...
        self.export_mode_single_radioButton = QRadioButton(self.export_mode_groupBox)
        self.buttonGroup = QButtonGroup(ColliderScopeUI)
        self.buttonGroup.setObjectName(u"buttonGroup")
        self.buttonGroup.addButton(self.export_mode_single_radioButton)
        self.export_mode_single_radioButton.setObjectName(u"export_mode_single_radioButton")
        self.export_mode_single_radioButton.setChecked(True)

        self.verticalLayout_24.addWidget(self.export_mode_single_radioButton)

        self.export_mode_batch_radioButton = QRadioButton(self.export_mode_groupBox)
        self.buttonGroup.addButton(self.export_mode_batch_radioButton)
        self.export_mode_batch_radioButton.setObjectName(u"export_mode_batch_radioButton")

        self.verticalLayout_24.addWidget(self.export_mode_batch_radioButton)
        ...
        self.export_mode_stackedWidget = QStackedWidget(self.export_mode_groupBox)
        ...
        sizePolicy13.setHeightForWidth(self.single_page.sizePolicy().hasHeightForWidth())
        self.single_page.setSizePolicy(sizePolicy13)
        ...
        sizePolicy9.setHeightForWidth(self.batch_page.sizePolicy().hasHeightForWidth())
        self.batch_page.setSizePolicy(sizePolicy9)
        ...
        self.file_export_batch_files_browse_pushButton = QPushButton(self.batch_page)
        self.file_export_batch_files_browse_pushButton.setObjectName(u"file_export_batch_files_browse_pushButton")
        self.file_export_batch_files_browse_pushButton.setAutoDefault(True)

        self.horizontalLayout_20.addWidget(self.file_export_batch_files_browse_pushButton)
        ...
        self.export_mode_stackedWidget.addWidget(self.batch_page)

        self.horizontalLayout_21.addWidget(self.export_mode_stackedWidget)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 1003, 266))
        ...
        self.file_export_batch_files_browse_pushButton.setDefault(False)
...
"Script", None))
        ...
        self.label_15.setText(QCoreApplication.translate("ColliderScopeUI", u"Mode", None))
        self.export_data_mode_comboBox.setItemText(0, QCoreApplication.translate("ColliderScopeUI", u"Batch", None))
