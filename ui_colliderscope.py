...
class Ui_ColliderScopeUI(object):
    def setupUi(self, ColliderScopeUI):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 274, 519))
...
"color: black;")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 1033, 268))
...
"Script", None))
        ...
        self.export_data_mode_comboBox.setItemText(3, QCoreApplication.translate("ColliderScopeUI", u"Combined", None))
